...
class TokenVerifier:
    ...
    def verify_id_token(self, id_token, clock_skew=0):
        return self.id_token_verifier.verify(id_token, self.request, clock_skew)
...
class _JWTVerifier:
    ...
    def verify(self, token, request, clock_skew=0):
